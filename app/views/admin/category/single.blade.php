...
<div class="row">
    <div class="col-lg-6">
        {{ Form::open(array('url' => 'admin/category/'.$category->name)) }}
            ...
            <div class="form-group">
                @if($category->image)
                <div class="dropzone" data-width="960" data-image="{{ url('category_images/'.$category->image) }}" data-ajax="false" data-height="540" data-resize="true" style="width: 50%; height: auto">
                @else
