            ...
            <div id="edit-recipe" class="col-xs-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 content-top">
                @if($recipe->id)
                    {{ ViewHelper::getBreadcrumbs(array(array('url' => URL::to('category/'.$recipe->category->name), 'text' => $recipe->category->name.' Recipes'),
                        array('url' => URL::to('recipe/'.$recipe->slug), 'text' => $recipe->name.' Recipes')), 'Edit') }}
                @else
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                @endif
                                <textarea id="recipe-description" class="{{ ViewHelper::addClass('invalid', $errors->first('prep_time'))  }}" name="description" onkeyup="textCounter(this,'counter', 300);">{{{ $recipe->description }}}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-5">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6">
                                                {{ Form::select('recipe-quantity-type', Recipe::$ingredientSizes, null, array('id' => 'recipe-quantity-type', 'class' => ViewHelper::addClass('invalid', $errors->first('ingredients')))) }}
                                            </div>
                                        </div>
                                    </div>
