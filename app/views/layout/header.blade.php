            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Sign in to access your favorites.</p>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div id="new-user">
                                ...
                                <ul>
                                    ...
                                    <li>• Save and post all your favorite recipes.</li>
                                </ul>
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <img id="alt-logo" src="{{ url('assets/img/logo-white.png') }}" />
                        <p>You're 10 seconds away from saving your favorites recipes and cooks.</p>
                            ...
                            <div class="col-xs-12 col-sm-6 hidden-xs">
                                <div id="why-register">
                                    <ul>
                                        ...
                                        <li>• Save your favorite recipes and cooks</li>
                                        <li>• Always free</li>
