                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-10">
                                    <p class="recipe-details">
                                        ...
                                        <a href="//www.pinterest.com/pin/create/button/?url={{ url(Request::url()) }}&media={{ url(ViewHelper::getRecipeImage($recipe->image)) }}&description={{ $recipe->description }}" data-pin-do="buttonPin" data-pin-config="beside" data-pin-color="white"><img src="//assets.pinterest.com/images/pidgets/pinit_fg_en_rect_white_20.png" style="margin-right: 10px;" /></a>
